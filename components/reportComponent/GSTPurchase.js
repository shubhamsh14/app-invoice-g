...
function GSTPurchase() {
    ...
    return (
        <Row>
            ...
            <Col md={8} lg={9}>
                <PageHeader pageName='GST Purchase (with HSN)' />
                <Row>
                    <Col md={5} lg={4}>
                        <DateSelector
                            startDate={startDate}
                ...
                <table border="1">
                    <thead>
                        <tr>
                            ...
                            <th style={{ border: '2px solid black', padding: '8px', textAlign: 'center' }}>Original Invoice No.</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style={{ border: '1px solid black', padding: '8px', textAlign: 'center' }}>{'001'}</td>
